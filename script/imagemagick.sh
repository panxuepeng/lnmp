...
Install_php_imagick() {
    ...
    elif [ -e "$php_install_dir/bin/phpize" ];then
...
[ -e "$php70_install_dir/bin/php" ] && Install_php_imagick  $php70_install_dir
[ -e "$php56_install_dir/bin/php" ] && Install_php_imagick  $php56_install_dir
[ -e "$php53_install_dir/bin/php" ] && Install_php_imagick  $php53_install_dir
